...
class Config:
    ...
    model: str = "huihui_ai/baronllm-abliterated:8b"
    n_iter: int = 10
...
def main():
    ...
    if config.prompt == Config.prompt and config.model == Config.model:
        print(f"\n⚠️ WARNING: Using default prompt and model. The classification heavily depends on the model's output for the specific question.")
